...
public class TableController extends BaseController {
    ...
    @GetMapping("")
    public ResponseEntity loadAll(HttpServletRequest request) {
    ...
    public ResponseEntity assignTo(@PathVariable("id") Integer id, HttpServletRequest request, @RequestBody User waiter) {
